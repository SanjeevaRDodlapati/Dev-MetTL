...
from mettl import evaluation as ev

from mettl.utils import ProgressBar, to_list, get_nb_sample, get_replicate_names, add_to_dict, stack_dict, reader, \
    load_model, data_reader_from_model
...
class App(object):
    ...
    def main(self, name, opts):
        ...
        model = load_model(opts.model_files)

        log.info('Loading data ...')
        nb_sample = get_nb_sample(opts.data_files, opts.nb_sample)
        ...
        meta_reader = reader(opts.data_files, ['chromo', 'pos'],
                                 nb_sample=nb_sample,
                                 batch_size=opts.batch_size,
                                 loop=False, shuffle=False)
