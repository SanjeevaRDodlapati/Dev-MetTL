...
# from ..utils import to_list, add_to_dict, stack_dict, threadsafe_generator, reader, int_to_onehot
...
def get_replicate_names(data_file, *args, **kwargs):
    ...
    return ls(data_file, 'inputs/cpg',
              recursive=False,
              groups=True,
              must_exist=False,
              *args, **kwargs)
